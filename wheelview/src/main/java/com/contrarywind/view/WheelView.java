...
//    private int textSize;//选项的文字大小
    private int textSizeOuter;//选中外文字大小
    private int textSizeCenter;//选中文字大小
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        textSizeCenter = getResources().getDimensionPixelSize(R.dimen.pickerview_textsize);//默认大小
        textSizeOuter = getResources().getDimensionPixelSize(R.dimen.pickerview_textsize);//默认大小
        ...
        if (attrs != null) {
            ...
            textSizeCenter = a.getDimensionPixelOffset(R.styleable.pickerview_wheelview_textSize, textSizeCenter);
            textSizeOuter = a.getDimensionPixelOffset(R.styleable.pickerview_wheelview_textSize, textSizeOuter);
    ...
    public final void setOuterTextSize(float size) {
        if (size > 0.0F) {
            textSizeOuter = (int) (context.getResources().getDisplayMetrics().density * size);
            paintOuterText.setTextSize(textSizeOuter);
        }
    }
