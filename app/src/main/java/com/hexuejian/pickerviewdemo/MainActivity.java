package com.hexuejian.pickerviewdemo;
...
import com.hexuejian.pickerviewdemo.bean.CardBean;
import com.hexuejian.pickerviewdemo.bean.ProvinceBean;
    ...
    private void initTimePicker() {//Dialog 模式下，在底部弹出
        ...
        if (mDialog != null) {
            ...
            if (dialogWindow != null) {
                dialogWindow.setWindowAnimations(com.hexuejian.pickerview.R.style.picker_view_slide_anim);//修改动画样式
    ...
    private void initOptionPicker() {//条件选择器初始化
        ...
        pvOptions = new OptionsPickerBuilder(this, new OnOptionsSelectListener() {
            ...
            public void onOptionsSelect(int options1, int options2, int options3, View v) {
                ...
                .setTitleText("城市选择")
                .setCenterTextSize(20)//设置滚轮文字大小
                .setOuterTextSize(20)//设置滚轮文字大小
