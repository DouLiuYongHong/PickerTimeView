...
public class WheelOptions<T> {
    ...
    public void setCenterTextSize(int textSize) {
        wv_option1.setCenterTextSize(textSize);
        wv_option2.setCenterTextSize(textSize);
        wv_option3.setCenterTextSize(textSize);
    }

    public void setOuterTextSize(int textSize) {
        wv_option1.setOuterTextSize(textSize);
        wv_option2.setOuterTextSize(textSize);
        wv_option3.setOuterTextSize(textSize);
    }
