...
import com.hexuejian.pickerview.configure.PickerOptions;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        initWheelTime(timePickerView , context);
    }

    private void initWheelTime(LinearLayout timePickerView , Context context) {
        wheelTime = new WheelTime(timePickerView, mPickerOptions.type, mPickerOptions.textGravity, context);
        ...
        wheelTime.setCenterTextSize(mPickerOptions.textSizeCenter);
        wheelTime.setOutTextSize(mPickerOptions.textSizeOuter);
    }
