package com.hexuejian.pickerview.view;
...
import com.hexuejian.pickerview.adapter.NumericWheelAdapter;
...
public class WheelTime {
    ...
    private int textSizeCenter;
    private int textSizeOuter;
    ...
    public WheelTime(View view, boolean[] type, int gravity, Context context) {
        super();
        this.view = view;
        this.type = type;
        this.gravity = gravity;
        textSizeCenter = (int) (context.getResources().getDisplayMetrics().density * 20);
        textSizeOuter = (int) (context.getResources().getDisplayMetrics().density * 20);
        setView(view);
    }
...
//                maxItem = endD;
    ...
    private void setCenterTextSize() {
        wv_day.setCenterTextSize(textSizeCenter);
        wv_month.setCenterTextSize(textSizeCenter);
        wv_year.setCenterTextSize(textSizeCenter);
        wv_hours.setCenterTextSize(textSizeCenter);
        wv_minutes.setCenterTextSize(textSizeCenter);
        wv_seconds.setCenterTextSize(textSizeCenter);
    }

    private void setOuterTextSize() {
        wv_day.setOuterTextSize(textSizeOuter);
        wv_month.setOuterTextSize(textSizeOuter);
        wv_year.setOuterTextSize(textSizeOuter);
        wv_hours.setOuterTextSize(textSizeOuter);
        wv_minutes.setOuterTextSize(textSizeOuter);
        wv_seconds.setOuterTextSize(textSizeOuter);
    }
     ...
     * @param textsize
     */
    public void setOutTextSize(int textsize) {
        this.textSizeOuter = textsize;
        setOuterTextSize();
    }
     ...
     * @param textsize
     */
    public void setCenterTextSize(int textsize) {
        this.textSizeCenter = textsize;
        setCenterTextSize();
    }
