package com.hexuejian.pickerview.builder;
...
public class OptionsPickerBuilder {
    ...
    public OptionsPickerBuilder setOuterTextSize(int textSize) {
        mPickerOptions.textSizeOuter = textSize;
        return this;
    }

    public OptionsPickerBuilder setCenterTextSize(int textSize) {
        mPickerOptions.textSizeCenter = textSize;
        return this;
    }
